 ...
 * @date 2023/2/9 10:05
 */
public class CodeGeneratorMybatis {
    ...
    public static String projectPath = "E:\\a-projects\\blog-backEnd\\src\\main\\";

    /**
     * 代码生成的目标路径
     */
    public static String generateTo = projectPath + "java";

    /**
     * mapper.xml的生成路径
     */
    public static String mapperXmlPath = projectPath + "resources\\mapper";
